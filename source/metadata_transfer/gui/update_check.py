...
# From Timelapse Video Processing (BIOMIS team, MIT licence; see THIRD_PARTY_NOTICES.txt).
"""Help → Check for updates: compare this version with the latest release on GitHub.
